...
municipalityName = 'City of Philadelphia'; // name of budget municipality
...
dataSource  = window.location.origin + '/datamade/data/phl/budget_finished.csv';

app.GlobalChartOpts = {
    estColor:   '#6e6e6e',
    estSymbol:  'circle',

    actualColor:  '#183ab8f5',
    actualSymbol: 'square',
